<template>
  <div style="padding: 5% 10%">
    ...
    <div style="display: flex; align-items: center;">
      <h1>Privacy Policy for 180Songs </h1>
      <div class="button-middle">
        <el-button type="success" icon="el-icon-remove" size="medium" style="margin-left: 16px;" round @click="$emit('closeTerm')">
          Close
        </el-button>
      </div>
    </div>

    <p>At 180Songs, accessible from https://180songs.com, one of our main priorities is the privacy of our visitors. This
      Privacy Policy document contains types of information that is collected and recorded by 180Songs and how we use
      it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
      the information that they shared and/or collect in 180Songs. This policy is not applicable to any information
    ...
    <p>180Songs follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of 180Songs.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on 180Songs, which are sent directly to users' browser. They
    ...
    <p>Note that 180Songs has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>180Songs's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
    ...
    <p>180Songs does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
