<template>
  <div style="padding: 20px; padding-left: 48px; padding-right: 48px; margin-top: 8px;" v-loading="loading_main">
    <div class="title-wrapper">
      <div class="title-section">
        Select your favorite genres
      </div>
    </div>
    <div class="button-middle" :class="{'hidden': listGenreActive === ''}">
      <el-button type="success" icon="el-icon-close" size="medium" round @click="clearAllGenres()">Clear all
        genre
      </el-button>
    </div>
    ...
    <div class="button-middle" :class="{'hidden': listGenreActive === ''}">
      <el-button type="success" icon="el-icon-plus" size="medium" round @click="createPlayList()">
        Create Play List
      </el-button>
    </div>
    ...
    getData() {
      ...
      axios.get('https://api.spotify.com/v1/recommendations/available-genre-seeds', {
        ...
        if (result.data.genres) {
          ...
          if(res.length > 0) res[0].active = true;
    ...
    getInfoUser() {
      ...
      axios.get('https://api.spotify.com/v1/me', {
        ...
        if (result.data) {
          ...
          this.$root.$emit('getUserInfo', result.data);
        }
        // eslint-disable-next-line no-unused-vars
      }).catch((error => {
        localStorage.removeItem('access_token_180song')
